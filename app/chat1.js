...
const Chatmain = () => {
  ...
  return (
    <div className="max-w-md mx-auto my-8 p-4 rounded-lg">
      <div className="mb-4">
        <div className="bg-[#e8e6e7] w-[270px] p-2 pr-4 rounded-tr-lg rounded-bl-lg rounded-br-lg inline-block">
      ...
      <div className="mb-4">
        <div className="bg-[#e8e6e7] w-[270px] p-3 pr-5 rounded-tr-lg rounded-bl-lg rounded-br-lg inline-block">
